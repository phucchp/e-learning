...
import { validatChangePassword, validatChangePasswordUsingToken, validateActiveUser, validateForgotPassword, validateLogin, validateRegister } from '../validators/UserValidator';
...
class AuthenticationRoutes extends BaseRoutes {
	...
	routes(): void {
		...
		this.router.post('/users/change-password', auth, validatChangePassword, validate, this.controller.changePassword);
		this.router.post('/users/forgot-password', validateForgotPassword, this.controller.forgotPassword);
		this.router.post('/users/change-password-token', validatChangePasswordUsingToken, validate, this.controller.changePasswordUsingToken);
	}
}
